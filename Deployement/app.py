...
st.image(r"C:\Users\LENOVO\Semantic Segmentation of Satellite imagery\original.png", caption = 'Data image, with a gap of 23 years')
...
st.image(r"C:\Users\LENOVO\Semantic Segmentation of Satellite imagery\euclidean.png")

st.header('Using Manhattan Distance')
st.image(r"C:\Users\LENOVO\Semantic Segmentation of Satellite imagery\manhattan.png")

st.header('Using Chebyshev Distance')
st.image(r"C:\Users\LENOVO\Semantic Segmentation of Satellite imagery\chebyshev.png")

st.header('Working of various distance metrics')
st.image(r"C:\Users\LENOVO\Semantic Segmentation of Satellite imagery\comparison.png")
