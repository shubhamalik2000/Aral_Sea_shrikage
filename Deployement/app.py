...
st.image("Deployement\original.png", caption = 'Data image, with a gap of 23 years')
...
st.image("Deployement\euclidean.png")

st.header('Using Manhattan Distance')
st.image("Deployement\manhattan.png")

st.header('Using Chebyshev Distance')
st.image("Deployement\chebyshev.png")

st.header('Working of various distance metrics')
st.image("Deployement\comparison.png")
